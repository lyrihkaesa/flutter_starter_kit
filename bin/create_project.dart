...
void main(List<String> args) async {
  ...
  // Parse optional arguments --org, --output, dan --build-runner
  ...
  print('🚀 Generating Flutter Project & AI Rules (flutter_starter)...');
  ...
  try {
    ...
    print('✏️ Updating package name & organization configuration...');
